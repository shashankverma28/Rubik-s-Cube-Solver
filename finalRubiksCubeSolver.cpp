...
{
    FILE *fp;
    string calcube = "python colorreader.py";
...
void setup(void)
{
    ...
    // // Call scancube to initialize the cube
    // scancube();
}
...
void solver()
{
    ...
    /*cube = {
      ...
      */
    string addfile = "type nul > input2.txt";
    ...
    fclose(fp);
    string compile = "python solver.py";
